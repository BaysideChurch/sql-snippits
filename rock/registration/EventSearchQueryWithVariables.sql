--
-- Just like the event search query but with the page parameter variables declared for easy testing
--
...
WHERE
  ...
  (
    @ministry = '' OR
    eicMinistryAv.[Value] = @ministry OR
    riMinistryAv.[Value] = @ministry
  ) AND
