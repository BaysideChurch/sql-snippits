DECLARE @today DATETIME = DATEADD(day, -3, GETDATE()); -- Typically always going to be a Monday
DECLARE @yesterdaySunday DATETIME = DATEADD(day, -1, CAST(@today AS DATE)); -- Typically always going to be a Sunday
